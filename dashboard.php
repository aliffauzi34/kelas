...
<body id="page-top">
	...
	<?php require_once '_sidebar.php'; ?>
					...
					<div class="card shadow">
						...
						<div class="card-body">
							<form action="proses_ubah.php" method="POST">
								...
								<div class="form-group">
									<button type="submit" class="btn btn-sm btn-primary" name="simpan" onclick="return confirm('Apakah anda yakin ingin mengubah data?')"><i class="fas fa-save"></i> Ubah</button>
								</div>
							</form>
						</div>
					</div>
		...
		<span>Copyright &copy; Muhammad Alif Nurfauzi</span>
		</div>
		</div>
		</footer>
		<!-- End of Footer -->
